...
(or Lie algebra representatione etc), we can deduce them as special cases of facts from this file.
...
theorem one_dimensional_of_simple_of_abelian [IsSimpleModule A V] [FiniteDimensional k V]
    [Nontrivial V] [IsAlgClosed k] [IsMulCommutative A] : Module.finrank k V = 1 := by
